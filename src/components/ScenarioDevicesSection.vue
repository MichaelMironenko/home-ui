  ...
  <section class="blk">
    <header class="blk__header">
      <div>
        ...
        <p class="blk__hint">Выберите группы или отдельные устройства. Устройства внутри выбранной группы исключаются из списка.</p>
      </div>
      <span v-if="totalSelected" class="counter">{{ totalSelected }}</span>
    </header>

    <p class="summary" :class="{ empty: !totalSelected }">
      {{ summary }}
    </p>
    ...
    <div v-if="!loading" class="rooms">
      ...
      >
        <header class="room__header">
          <h3>{{ section.name || 'Без комнаты' }}</h3>
              ...
              <label class="entry__label">
                ...
                <div class="entry__title">
                  <div class="entry__headline">
                    ...
                    <span class="badges">
                      <span v-for="badge in capabilityBadges(group.supports)" :key="badge" class="badge">{{ badge }}</span>
                    </span>
                  </div>
                ...
                <label class="member">
                  ...
                  <div class="member__title">
                    <div class="entry__headline">
                      ...
                      <span class="badges">
                        <span v-for="badge in capabilityBadges(device.supports)" :key="badge" class="badge">{{ badge }}</span>
                      </span>
                    </div>
